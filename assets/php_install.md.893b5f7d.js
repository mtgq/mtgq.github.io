import{_ as s,c as n,o as a,d as l}from"./app.d421a35c.js";const D=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"php/install.md"}'),p={name:"php/install.md"},e=l(`<h2 id="nginx-环境服务器" tabindex="-1">Nginx 环境服务器 <a class="header-anchor" href="#nginx-环境服务器" aria-hidden="true">#</a></h2><p>在Nginx低版本中，是不支持PATHINFO的，但是可以通过在Nginx.conf中配置转发规则实现：</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki"><code><span class="line"><span style="color:#A6ACCD;">location /m/ {</span></span>
