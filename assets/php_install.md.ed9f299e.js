import{_ as s,c as n,o as a,a as l}from"./app.68e8bcde.js";const D=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"php/install.md"}'),p={name:"php/install.md"},e=l(`<h2 id="nginx-\u73AF\u5883\u670D\u52A1\u5668" tabindex="-1">Nginx \u73AF\u5883\u670D\u52A1\u5668 <a class="header-anchor" href="#nginx-\u73AF\u5883\u670D\u52A1\u5668" aria-hidden="true">#</a></h2><p>\u5728Nginx\u4F4E\u7248\u672C\u4E2D\uFF0C\u662F\u4E0D\u652F\u6301PATHINFO\u7684\uFF0C\u4F46\u662F\u53EF\u4EE5\u901A\u8FC7\u5728Nginx.conf\u4E2D\u914D\u7F6E\u8F6C\u53D1\u89C4\u5219\u5B9E\u73B0\uFF1A</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki"><code><span class="line"><span style="color:#A6ACCD;">location /m/ {</span></span>
